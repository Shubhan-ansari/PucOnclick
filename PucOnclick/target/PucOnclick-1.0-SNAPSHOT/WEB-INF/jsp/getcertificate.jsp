...
<head>
<meta charset="UTF-8">
<title>PUCOnclick | Certificate</title>
...
<!--            <img src="/your-web-context-path/resources/img/PUC_logo.png" alt="PucOnClick Logo" style="margin-top: 10px; width: 70%; height: 70%;">-->
            <img src="${pageContext.request.contextPath}/resources/img/PUC_logo.jpg" alt="PucOnClick Logo" style="margin-top: 10px; width: 70%; height: 70%;" />

        </div>
        <div class="col" align="center">
            <img src="${pageContext.request.contextPath}/resources/img/Ministry_of_Road_Transport_and_Highways.png" alt="PucOnClick Logo" style="margin-top: 10px;width: 90%; height: 70%;">
        </div>
    </div>
    <div class="row">
        <div class="col">
    ...
    <div class="row">
        <div class="col" align="left">
            ...
            <br>
                    ...
                    <div class="col" align="center">
                        <img src="${pageContext.request.contextPath}/resources/img/Slider-2-MMVD.png" alt="PucOnClick Logo" style="margin-top: 10px; width: 70%; height: 70%;" />
                    </div>
    </div>

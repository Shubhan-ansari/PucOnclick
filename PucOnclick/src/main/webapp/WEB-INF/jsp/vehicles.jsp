...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <img src="${pageContext.request.contextPath}/resources/img/104baa46-ffa5-4624-9921-06c0fff7e9f3.png" alt="PucOnClick Logo" style=" width: 100%; height: 100%;" />
        </div>
        <div class="col">
            <%
                int colind=0;
...
//                    PreparedStatement stmt1 = con.prepareStatement("select * from vehicles, vehicle_image where vehicles.registration_no=vehicle_image.registration_no and username=?");
...
//                        byte[] imageBytes = outputStream.toByteArray();
                        ...
                        <td>
                            <div class="project-cards"><!--                                    <img class="card-img-top" alt="..." align="center" src="data:image/jpeg;base64,<%--= Base64.getEncoder().encodeToString(imageBytes) --%>"/>-->
                                <div class="card">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="addvehicle" method="post">
                            ...
                            <input type="text" id="project-title" class="form-control form-input" placeholder="Vehicle Color" name="e"/><br>
